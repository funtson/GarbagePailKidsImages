...
num_stickers = [5, 12, 5, 8, 10, 10, 5, 18, 18, 5, 9]
prefixes = ["alien", "apocalypse", "president", "biotech", "classic", "dumbdeath", "monsters", "naturaldisaster", "nuclear", "pollution", "plagues"]
counter = 1
