...
num_stickers = [2, 7, 10, 8, 5, 6, 5, 5, 8, 5, 8, 4, 6, 12, 8, 10, 5, 8]
prefixes = ["bomb", "cartoon", "classicrerun", "comicbook", "comedy", "crime", "daytime" , "drama", "food", "gameshow", "horror", "latenight", "news", "reality", "reboot", "scifi", "streaming", "syndicated"]
counter = 1
